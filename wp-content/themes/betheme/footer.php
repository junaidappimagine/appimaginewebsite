					...
					<div class="copyright">
						<?php 
							if( mfn_opts_get('footer-copy') ){
								...
								echo '&copy; '. date( 'Y' ) .' '. get_bloginfo( 'name' ) .'. All Rights Reserved. <a target="_blank" rel="nofollow" href="http://www.appimagine.com">Appimagine</a>';
							}
						?>
					</div>
